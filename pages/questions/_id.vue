        ...
        <v-flex>
          <v-card>
            ...
            <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <a :href="'https://twitter.com/share?url=http://localhost:3000/questions/' + question.question_key + '&text=' + question.title + ' - ' + question.body.substring(0, 100) + '&hashtags=EOSのエアドロ質問箱'" class="twitter-share-button" data-size="large" data-show-count="false">Tweet</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                &nbsp;  &nbsp;                
